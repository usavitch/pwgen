; ======================================================================
; c23.asm - КРИПТОСТОЙКИЙ ГЕНЕРАТОР ПАРОЛЕЙ (NASM x86-64)
; Версия с Quarter-Round + SSE ChaCha20
; ======================================================================
...
; ======================================================================
; ИНИЦИАЛИЗАЦИЯ КУБА (с Quarter-Round)
; ======================================================================
init_cups:
    PUSH_CALLEE
    mov     ecx, CUPS_SIZE
...
; ======================================================================
; РАЗБРАСЫВАНИЕ ШАРИКОВ (с Quarter-Round)
; ======================================================================
collect_and_splash:
    PUSH_CALLEE
    mov     r12d, 10
...
; ======================================================================
; ИЗВЛЕЧЕНИЕ ШАРИКОВ (с Quarter-Round)
; ======================================================================
sip_from_cups:
    PUSH_CALLEE
    mov     r12d, 8
